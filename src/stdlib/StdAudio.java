...
public final class StdAudio {
    ...
    private static void init() {
        try {
            ...
            final AudioFormat format = new AudioFormat(SAMPLE_RATE, BITS_PER_SAMPLE, 1, true, false);
    ...
    private static byte[] readByte(String filename) {
        ...
        try {
            ...
            // try to read from URL
                ...
                final URL url = StdAudio.class.getResource(filename);
    ...
    public static void save(String filename, double[] input) {
        ...
        try {
            ...
            final AudioInputStream ais = new AudioInputStream(bais, format, input.length);
