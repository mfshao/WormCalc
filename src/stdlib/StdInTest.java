...
public class StdInTest {
    ...
    public static Object escape(Object original) {
        if (original instanceof Character) {
            final char u = ((Character)original);
            final int idx = "\b\t\n\f\r\"\'\\".indexOf(u);
            if (idx >= 0)
    ...
    public static void test(String input, Object[][] steps, boolean useStdIn) {
        ...
        for (Object[] step : steps) {
            final String cmd = (String)step[0];
            final Object expected = step[1];
            Object result;

            final String preamble = "Failed input %s\nStep %d (%s)\n";
            ...
            if (expected.getClass().isArray()) {
                ...
                final Object r = result, e = expected; // to shorten lines below
                final int rl = Array.getLength(r);
                final int el = Array.getLength(e);
                if (el != rl)
    ...
    public static void main(String[] args) {
        ...
        final Object[][] expected = new Object[2000][2];
